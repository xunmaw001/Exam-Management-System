          ...
          <el-form-item class="input" label="邮箱" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="邮箱" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主教课程" prop="zhujiaokecheng">
          <el-input v-model="ruleForm.zhujiaokecheng" 
              placeholder="主教课程" clearable  :readonly="ro.zhujiaokecheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主教课程" prop="zhujiaokecheng">
              <el-input v-model="ruleForm.zhujiaokecheng" 
                placeholder="主教课程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
