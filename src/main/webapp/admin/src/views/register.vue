  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">考试管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
												...
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">主教课程</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhujiaokecheng" class="input" type="text" placeholder="主教课程">
			   </div>
			 </div> -->
			<el-form-item label="主教课程" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.zhujiaokecheng" autocomplete="off" placeholder="主教课程" type="text" />
			</el-form-item>
